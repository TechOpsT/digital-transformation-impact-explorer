...
const required = [
  ...
  "charts/transformation-explorer/Chart.yaml",
  "charts/transformation-explorer/values.yaml",
  "charts/transformation-explorer/values-kind.yaml",
  "charts/transformation-explorer/templates/applications.yaml",
  "charts/transformation-explorer/templates/data.yaml",
  "charts/transformation-explorer/templates/networkpolicies.yaml",
  "charts/transformation-explorer/templates/monitoring.yaml",
  "docs/decisions/0007-kubernetes-deployment-boundary.md",
  "docs/runbooks/kubernetes-deployment.md",
  "docs/runbooks/observability-queries.md",
  "docs/evidence/phase-2-validation.md",
  "docs/evidence/phase-2-completion.md",
  "tests/kubernetes/validate-chart.mjs",
  "tests/kubernetes/cluster-smoke.mjs",
